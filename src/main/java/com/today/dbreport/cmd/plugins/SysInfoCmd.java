...
public class SysInfoCmd implements Command{
    ...
    private class SysInfoParams {
        ...
        @Parameter(names = {"-props"}, required=false, description = "使用JVM配置. Usage -props.")
        public boolean props = false;

        @Parameter(names = {"-cp","-classpath"}, required=false, description = "展示JVM classpath")
        public boolean cp = false;      
        
        @Parameter(names = {"-mem","-memory"}, required=false, description = "展示当前JVM的内存使用情况")
